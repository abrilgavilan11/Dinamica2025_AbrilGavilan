...
<body>
    ...
    <main class="container text-center" style="margin-top: 100px;">
      <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">Buscar Auto por Patente</h2>

        <form method="post" action="auto_resultado.php" class="mx-auto" style="max-width: 400px;">
          <div class="mb-3">
        ...
        <div class="text-center mt-4">
          <a href="auto_listar.php" class="btn btn-secondary">Ver todos los autos</a>
        </div>
      </div>
    </main>
