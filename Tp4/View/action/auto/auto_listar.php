...
<body>
    ...
    <main class="container text-center" style="margin-top: 100px;">
      <div class="container mt-5">
        <h2 class="text-center text-primary mb-4">Listado de Autos Registrados</h2>
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <?php foreach ($listaAutos as $auto): 
                $persona = new Persona();
                $persona->setNroDni($auto->getDniDuenio());
                $persona->cargar();
              ?>
                <tr>
        ...
        <?php else: ?>
          <div class="alert alert-warning text-center">No hay autos registrados en la base de datos.</div>
        <?php endif; ?>
