...
class Product extends BaseModel
{
    ...
    {
        $sql = "SELECT p.*, c.catnombre FROM producto p JOIN categoria c ON p.idcategoria = c.idcategoria ORDER BY p.idproducto DESC";
    ...
    {
        $sql = "SELECT * FROM producto ORDER BY idproducto DESC LIMIT ?";
        $stmt = $this->pdo->prepare($sql);
        $stmt->execute([$limit]);
        return $stmt->fetchAll(\PDO::FETCH_ASSOC);
    }
