...
// Recuperar los valores de búsqueda y categoría desde el controlador para mantenerlos en el formulario
...
document.addEventListener('DOMContentLoaded', function() {
    console.log("[v0] Catalog page loaded");
    ...
    productCards.forEach(card => {
        ...
        sizeButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                console.log("[v0] Size selected:", selectedSize);
            });
        });
        ...
        colorButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                console.log("[v0] Color selected:", selectedColor);
            });
        });
        ...
        addButton.addEventListener('click', function() {
            ...
            console.log("[v0] Adding product:", productId, "Size:", selectedSize, "Color:", selectedColor);
            ...
            .then(data => {
                console.log("[v0] Add to cart response:", data);
                if (data.success) {
                    ...
                    console.log("[v0] Cart counter updated to:", data.cartCount);
                } else {
