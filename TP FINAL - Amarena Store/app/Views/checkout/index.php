                    ...
                    <div class="form-section">
                        ...
                        <div class="payment-methods">
                            <div class="payment-method" data-method="mercadopago">
                                <input type="radio" id="mp" name="payment_method" value="mercadopago" checked>
                                <label for="mp">
                                    ...
                                    <div class="method-info">
                                        ...
                                        <span class="method-desc">Tarjetas, efectivo y más</span>
                                    </div>
                                </label>
                            </div>
    ...
    if (paymentMethod === 'mercadopago') {
        ...
        .then(data => {
            if (data.success && data.init_point) {
                ...
                alert('Error al procesar el pago: ' + (data.message || 'Intenta nuevamente'));
            }
        })
        .catch(err => {
